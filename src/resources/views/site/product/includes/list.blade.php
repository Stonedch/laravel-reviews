<div class="row">
    ...
    @foreach ($products as $product)
        ...
        <div class="col-lg-4 mb-4">
            ...
            <!-- Card Narrower -->
            <div class="card card-cascade narrower h-75">
                ...
                @else
                    <div class="view view-cascade overlay">
                        <img class="card-img-top rounded-top" src="{{ asset('images/emptypicture.jpg') }}">
                        <a href="{{ route('site.product.show', $product->slug) }}">
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
                ...
                <!-- Card content -->
                <div class="card-body card-body-cascade text-center h-70 mb-5">

                    <!-- Title -->
                    <h4 class="card-title text-center pb-1 pt-1"> {{ $product->name }} </h4>
                    <!-- Text -->
